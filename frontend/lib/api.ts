...
export const apiClient = {
  ...
  getAdminLlmLogs: (token: string) => apiRequest<{ items: { id: number; user_id: number | null; user_name: string | null; user_email: string | null; platform: string; message_type: string; provider: string | null; intent: string | null; status: string; raw_message: string | null; parsed_result: Record<string, unknown> | null; error_message: string | null; created_at: string }[]; total: number }>("/admin/llm-logs", { method: "GET", token }),
