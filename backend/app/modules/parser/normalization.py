...
CATEGORY_KEYWORD_ALIASES: tuple[tuple[str, str], ...] = (
    ...
    ("shopeepay", "e wallet belanja"),
    ("gopay", "e wallet belanja"),
    ("ovo", "e wallet belanja"),
    ("dana", "e wallet belanja"),
    ...
    ("toefl", "kursus pendidikan"),
    ("magang", "gaji income pemasukan"),
    ("part time", "gaji income pemasukan"),
    ...
    ("cashback", "tabungan income"),
    ("refund", "tabungan income"),
