...
EXPECTED_CASES = [
    ...
    expected_case(16, "gajian 2 juta", ("saved",), transaction_type="income"),
    expected_case(17, "masuk uang freelance 350k", ("saved",), transaction_type="income"),
    expected_case(18, "dikasih mama 100 ribu", ("saved",), transaction_type="income"),
    expected_case(19, "refund shopee 45rb", ("saved",), transaction_type="income"),
    expected_case(28, "msuk uang 100k dari temen", ("saved",), transaction_type="income"),
    expected_case(29, "beli pulsa lima puluh ribu", ("saved",), transaction_type="expense"),
    expected_case(49, "list pengeluaran", ("list_expense",)),
    expected_case(50, "pengeluaran terbaru", ("list_expense",)),
    ...
    expected_case(65, "apa yang harus aku kurangi?", ("cutback_advice",)),
    expected_case(74, "kategori print jurnal masuk mana?", ("category_lookup", "finance_chat")),
    expected_case(75, "ganti kategori transaksi terakhir jadi pendidikan", ("edit_last_transaction",)),
    expected_case(76, "pengeluaran kuliah bulan ini berapa?", ("category_summary",)),
    expected_case(77, "aku sering keluar uang buat apa?", ("spending_analysis", "finance_chat")),
    expected_case(84, "kamu bisa bantu apa?", ("bot_profile",)),
    expected_case(85, "bantu aku atur uang bulan ini", ("finance_chat", "saving_advice")),
    ...
    expected_case(88, "mending beli kopi tiap hari atau hemat?", ("finance_chat", "saving_advice")),
    expected_case(89, "bikin rencana hemat anak kos", ("finance_chat", "saving_advice")),
    expected_case(90, "aku pengen nabung 500rb bulan ini, bisa ga?", ("finance_chat", "saving_goal")),
    expected_case(91, "gimana cara ngurangin jajan?", ("finance_chat", "saving_advice")),
    expected_case(92, "kasih evaluasi keuangan aku", ("finance_chat", "finance_health")),
    expected_case(93, "aku harus stop langganan apa?", ("finance_chat", "cutback_advice")),
    expected_case(94, "menurutmu pengeluaran aku sehat gak?", ("finance_health",)),
    expected_case(95, "kopi 18", ("needs_confirmation",)),
    expected_case(96, "15k", ("needs_confirmation",)),
    ...
    expected_case(100, "ini mahal gak?", ("finance_chat",)),
    expected_case(101, "catat yang tadi", ("needs_context", "finance_chat")),
    expected_case(102, "uangku habis", ("needs_confirmation", "finance_chat")),
    expected_case(103, "aku lupa nominalnya", ("needs_confirmation", "needs_context")),
    expected_case(104, "tadi bayar dua kali", ("duplicate_check", "finance_chat")),
    expected_case(105, "salah catat dong", ("needs_context", "finance_chat")),
]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("salah, totalnya 15rb", "edit_updated"),
    ],
)
